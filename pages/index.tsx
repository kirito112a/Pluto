    ...
    <>
      ...
      <div className='container'>
        ...
        <div className={styles.fly_box}>
          <Marquee> <a >ยินดีต้อนรับเข้าสู่เว็บไซต์ สล็อต คาสิโนออนไลน์ pgauto-108.com พร้อมระบบฝาก-ถอนออโต้ 10 วินาที พนันออนไลน์ อันดับหนึ่ง ให้บริการ สล็อต คาสิโนออนไลน์ เราให้บริการด้านการเดิมพันคาสิโนบนเว็บแบบครบวงจรตลอด 24ชม. </a> </Marquee>
        </div>

        <div className={styles.container}>
          <div className={styles.imgmain1} > <Image className="img-fluid" src="/present.png" width={900} height={"500"} alt="img1" ></Image>
  ...
  return (
    <>
      ...
      <div className='container'>
        ...
        <div className={styles.container}>
          <div className={styles.imgmain1} > <Image className="img-fluid" src="/present.png" width={900} height={"400"} alt="img1" ></Image>
